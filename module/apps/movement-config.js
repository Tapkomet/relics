...
export default class ActorMovementConfig extends DocumentSheet {
  ...
  /** @override */
	static get defaultOptions() {
      ...
      classes: ["relics"],
      template: "systems/relics/templates/apps/movement-config.html",
      width: 300,
      height: "auto"
    });
  }
  ...
  /** @override */
  get title() {
    return `${game.i18n.localize("RELICS.MovementConfig")}: ${this.document.name}`;
  }
  ...
  getData(options) {
    ...
    const data = {
      ...
      units: CONFIG.RELICS.movementUnits
    };
