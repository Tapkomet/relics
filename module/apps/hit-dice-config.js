...
export default class ActorHitDiceConfig extends DocumentSheet {
    ...
    static get defaultOptions() {
        return foundry.utils.mergeObject(super.defaultOptions, {
            classes: ["relics", "hd-config", "dialog"],
            template: "systems/relics/templates/apps/hit-dice-config.html",
            width: 360,
            height: "auto"
        });
    }
    ...
    /** @override */
    get title() {
        return `${game.i18n.localize("RELICS.HitDiceConfig")}: ${this.object.name}`;
    }
